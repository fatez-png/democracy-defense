...
export default async function PaperDetail(props: PageProps) {
  ...
  const isCCModeration = slug === "cross-country-content-moderation-nlp";
  const isUDHR = slug === "llms-udhr-human-rights-evaluation";
        ...
        {isSocialHarm ? (
          ...
          <>
            ...
            <div className="mt-3">
              <img
                src="/hr_pic.png"
                alt="UDHR human rights evaluation illustrative figure"
                className="w-full h-auto object-contain border border-black/10 dark:border-white/10"
              />
            </div>
            <p className="mt-4 text-foreground/90 whitespace-pre-line">{paper.summary}</p>
          ...
          <>
            ...
            <div className="mt-3">
              <img
                src="/ccmoderation.png"
                alt="Cross-country content moderation illustrative figure"
                className="w-full h-auto object-contain border border-black/10 dark:border-white/10"
              />
            </div>
            <p className="mt-4 text-foreground/90 whitespace-pre-line">{paper.summary}</p>
